...
\lstinputlisting[language=Python, caption={CNN Model Code}]{listings/CNN_model.py}
...
\lstinputlisting[language=Python]{listings/CNN_save_load_model.py}
...
\lstinputlisting[language=Python]{listings/LSTM_save_load_model.py}
\newpage
