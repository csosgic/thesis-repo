...
%	variants
%	assets effected
%attacks - their target - their consequences - some solutions maybe
...
%(1) applications of ML-based IDS in transmission and distribution power components of smart grids.
%(2) dataset generation and usage for ML-based IDS.
%(3) a range of ML-based IDS techniques used in smart grid environments.
%(4) performance metrics complexity analysis, and evaluation testbeds.
%(5) lessons learned and future research directions.
...
%cite{https://docs.python.org/3/faq/general.html#what-is-python}
